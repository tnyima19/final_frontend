...
// The aliases of reducers in this file will be assigned as the names of the ekys 
// in the Redux store, with the values being the respective individual reducers;
